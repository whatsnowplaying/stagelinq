...
from stagelinq.messages import DiscoveryMessage, StateEmitMessage, DISCOVERY_MAGIC
...
def test_discovery_packets():
    ...
    try:
        ...
        print(f"OK Successfully parsed discovery message!")
...
def test_state_packets():
    ...
    try:
        ...
        print(f"OK Successfully parsed state message!")
...
def test_bpm_state_packet():
    ...
    try:
        ...
        print(f"OK Successfully parsed BPM state message!")
        print(f"   State name: {message.name}")
        print(f"   JSON data: {message.json_data}")
